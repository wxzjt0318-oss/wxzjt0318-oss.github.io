...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		imageApi: {
			enable: true,
			desktopUrl: "https://www.loliapi.com/acg/pc/",
			mobileUrl: "https://www.loliapi.com/acg/pe/",
			timeoutMs: 5000,
			requestParams: {},
		},
		homeText: {
		...
		credit: { enable: false, text: "图片来源", url: "" },
