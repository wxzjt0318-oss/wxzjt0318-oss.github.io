...
export const zh_CN: Translation = {
	...
	[Key.gamesHours]: "小时",
	[Key.gamesRating]: "评分",
	[Key.gamesStatsTotal]: "游戏总数",
	[Key.gamesStatsAvgRating]: "平均评分",
	[Key.gamesStatsLastUpdated]: "数据更新时间",
	[Key.gamesFilterAll]: "全部",
	[Key.gamesStatusPlanned]: "计划游玩",
	[Key.gamesStatusOnHold]: "搁置中",
	[Key.gamesStatusDropped]: "已弃坑",
	[Key.gamesReleaseDate]: "发售日期",
	[Key.gamesDeveloper]: "开发商",
	[Key.gamesPlatform]: "平台",
	[Key.gamesUnknown]: "未知",
	[Key.gamesOpenOnBangumi]: "在 Bangumi 打开 {title}",
	[Key.gamesStatusLabel]: "状态：{status}",
	[Key.gamesRatingBadge]: "评分 {rating}",
	[Key.gamesEmptyHint]: "请检查 Bangumi 配置或网络连接",
	[Key.gamesAnnounceItems]: "在“{label}”下显示 {count} 个结果",
	[Key.gamesAnnounceSearch]: "（搜索“{term}”）",
