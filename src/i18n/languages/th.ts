...
export const th: Translation = {
	...
	[Key.gamesStatsTotal]: "ทั้งหมด",
	[Key.gamesStatsAvgRating]: "คะแนนเฉลี่ย",
	[Key.gamesStatsLastUpdated]: "อัปเดตล่าสุด",
	[Key.gamesFilterAll]: "ทั้งหมด",
	[Key.gamesStatusPlanned]: "วางแผนเล่น",
	[Key.gamesStatusOnHold]: "พักไว้",
	[Key.gamesStatusDropped]: "เลิกเล่น",
	[Key.gamesReleaseDate]: "วันที่วางจำหน่าย",
	[Key.gamesDeveloper]: "นักพัฒนา",
	[Key.gamesPlatform]: "แพลตฟอร์ม",
	[Key.gamesUnknown]: "ไม่ทราบ",
	[Key.gamesOpenOnBangumi]: "เปิด {title} บน Bangumi",
	[Key.gamesStatusLabel]: "สถานะ: {status}",
	[Key.gamesRatingBadge]: "คะแนน {rating}",
	[Key.gamesEmptyHint]: "โปรดตรวจสอบการตั้งค่า Bangumi หรือการเชื่อมต่อเครือข่าย",
	[Key.gamesAnnounceItems]: "กำลังแสดง {count} รายการใน “{label}”",
	[Key.gamesAnnounceSearch]: " ค้นหา “{term}”",
	...
	[Key.paginationFirst]: "หน้าแรก",
	[Key.paginationLast]: "หน้าสุดท้าย",
