...
export const zh_TW: Translation = {
	...
	[Key.gamesHours]: "小時",
	[Key.gamesRating]: "評分",
	[Key.gamesStatsTotal]: "遊戲總數",
	[Key.gamesStatsAvgRating]: "平均評分",
	[Key.gamesStatsLastUpdated]: "資料更新時間",
	[Key.gamesFilterAll]: "全部",
	[Key.gamesStatusPlanned]: "計畫遊玩",
	[Key.gamesStatusOnHold]: "擱置中",
	[Key.gamesStatusDropped]: "已棄坑",
	[Key.gamesReleaseDate]: "發售日期",
	[Key.gamesDeveloper]: "開發商",
	[Key.gamesPlatform]: "平台",
	[Key.gamesUnknown]: "未知",
	[Key.gamesOpenOnBangumi]: "在 Bangumi 開啟 {title}",
	[Key.gamesStatusLabel]: "狀態：{status}",
	[Key.gamesRatingBadge]: "評分 {rating}",
	[Key.gamesEmptyHint]: "請檢查 Bangumi 設定或網路連線",
	[Key.gamesAnnounceItems]: "在「{label}」下顯示 {count} 個結果",
	[Key.gamesAnnounceSearch]: "（搜尋「{term}」）",
