...
export const vi: Translation = {
	...
	[Key.gamesStatsTotal]: "Tổng cộng",
	[Key.gamesStatsAvgRating]: "Điểm trung bình",
	[Key.gamesStatsLastUpdated]: "Cập nhật lần cuối",
	[Key.gamesFilterAll]: "Tất cả",
	[Key.gamesStatusPlanned]: "Dự định chơi",
	[Key.gamesStatusOnHold]: "Tạm dừng",
	[Key.gamesStatusDropped]: "Đã bỏ",
	[Key.gamesReleaseDate]: "Ngày phát hành",
	[Key.gamesDeveloper]: "Nhà phát triển",
	[Key.gamesPlatform]: "Nền tảng",
	[Key.gamesUnknown]: "Không rõ",
	[Key.gamesOpenOnBangumi]: "Mở {title} trên Bangumi",
	[Key.gamesStatusLabel]: "Trạng thái: {status}",
	[Key.gamesRatingBadge]: "Điểm {rating}",
	[Key.gamesEmptyHint]: "Vui lòng kiểm tra cấu hình Bangumi hoặc kết nối mạng",
	[Key.gamesAnnounceItems]: "Đang hiển thị {count} mục trong “{label}”",
	[Key.gamesAnnounceSearch]: " với tìm kiếm “{term}”",
