...
export const ko: Translation = {
	...
	[Key.gamesHours]: "시간",
	[Key.gamesRating]: "평점",
	[Key.gamesStatsTotal]: "총 게임 수",
	[Key.gamesStatsAvgRating]: "평균 평점",
	[Key.gamesStatsLastUpdated]: "데이터 업데이트 시간",
	[Key.gamesFilterAll]: "전체",
	[Key.gamesStatusPlanned]: "플레이 예정",
	[Key.gamesStatusOnHold]: "보류 중",
	[Key.gamesStatusDropped]: "중단함",
	[Key.gamesReleaseDate]: "발매일",
	[Key.gamesDeveloper]: "개발사",
	[Key.gamesPlatform]: "플랫폼",
	[Key.gamesUnknown]: "알 수 없음",
	[Key.gamesOpenOnBangumi]: "Bangumi에서 {title} 열기",
	[Key.gamesStatusLabel]: "상태: {status}",
	[Key.gamesRatingBadge]: "평점 {rating}",
	[Key.gamesEmptyHint]: "Bangumi 설정 또는 네트워크 연결을 확인해 주세요",
	[Key.gamesAnnounceItems]: "“{label}”에서 {count}개 표시 중",
	[Key.gamesAnnounceSearch]: " (검색: “{term}”)",
