...
export const ja: Translation = {
    ...
    [Key.rssSubtitle]: "RSSで購読して、最新の記事と更新を第一時間で取得する",
    [Key.rssLink]: "RSSリンク",
    ...
    [Key.rssBenefit1]:
        "手動で訪問することなく、最新のウェブサイトコンテンツを迅速に取得",
    ...
    [Key.atomSubtitle]: "Atomで購読して、最新の記事と更新を第一時間で取得する",
    ...
    [Key.guestbookSubtitle]: "足跡を残して、あなたの思いを共有しましょう",
};
